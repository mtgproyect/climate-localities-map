...
## Ajuste visual de iconos

La versión actual muestra las localidades con un marcador compacto:
- solo icono del tiempo;
- temperatura al lado;
- luna por la noche cuando la condición es despejado;
- sol de día cuando la condición es despejado.

Se eliminaron los pines tipo gota para que el mapa se vea más limpio.
